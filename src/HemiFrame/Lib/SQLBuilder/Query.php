            ...
            switch ($this->getQueryType()) {
                ...
                case "insertDelayed":
                    if ($this->getQueryType() == "insertInto") {
                        ...
                        $queryString .= "INSERT IGNORE ";
                    } elseif ($this->getQueryType() == "insertDelayed") {
                        $queryString .= "INSERT DELAYED ";
                    }
                    ...
                    if (!empty($this->setColumns)) {
                        ...
                        $queryString .= "SET " . implode(", ", $setColumns) . " ";
                    }
                    ...
                    foreach ($this->whereConditions as $key => $value) {
                        ...
                        if ($key == 0) {
                            $queryString .= $value['condition'] . " ";
                        } else {
                            $queryString .= $value['whereOperator'] . " " . $value['condition'] . " ";
                        }
                    }
                ...
                case "select":
                    ...
                    foreach ($this->joinTables as $joinTable) {
                        ...
                        $queryString .= trim($joinTable['type'] . " " . $joinTable['table'] . $joinTable['alias'] . " ON " . $joinTable['relation']) . " ";
                    }
                    ...
                    if (count($this->havingConditions) > 0) {
                        ...
                        foreach ($this->havingConditions as $value) {
                            if ($i == 1) {
                                ...
                                $havingConditions .= $value['operator'] . " " . $value['condition'] . " ";
                            }
                            $i++;
                        }
                    ...
                    if (count($this->orderByColumns) > 0) {
                        $queryString .= "ORDER BY " . implode(",", $this->orderByColumns) . " ";
                    }
                ...
                default:
                    throw new QueryException("Wrong query type");
                    break;
            }
        }
